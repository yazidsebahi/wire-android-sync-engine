...
class SpotifyClientSpec extends FeatureSpec with Matchers with JsonResponseFromResources with OptionValues with RobolectricTests {
  ...
  feature("response parsing") {
    scenario("parse track response") {
      ...
      asset shouldEqual AssetData(metaData = Some(AssetMetaData.Image(Dim2(640, 640), "2")), source = Some(Uri.parse("https://i.scdn.co/image/64a7ae4a4804ae88f3b93af220c2eff8ee9b2882")))
...
//        ("2", "https://i.scdn.co/image/64a7ae4a4804ae88f3b93af220c2eff8ee9b2882", 640, 640))
    ...
    scenario("parse playlist response") {
      ...
      image shouldEqual AssetData(metaData = Some(AssetMetaData.Image(Dim2(0, 0), "0")), source = Some(Uri.parse("https://u.scdn.co/images/pl/default/02c1007d606188e383f00571520d97e488c7dc28")))
    }
  }
