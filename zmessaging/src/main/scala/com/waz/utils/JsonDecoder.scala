...
object JsonDecoder {
  ...
  implicit def decodeEid(s: Symbol)(implicit js: JSONObject): EventId = EventId(js.getString(s.name))
  ...
  implicit def decodeOptEid(s: Symbol)(implicit js: JSONObject): Option[EventId] = opt(s, js => EventId(js.getString(s.name)))
  ...
  implicit def decodeRImageDataId(s: Symbol)(implicit js: JSONObject): RImageDataId = RImageDataId(js.getString(s.name))
