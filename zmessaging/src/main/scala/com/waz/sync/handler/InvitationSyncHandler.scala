...
class InvitationSyncHandler(invitationService: InvitationService, userService: UserService, userSync: UsersSyncHandler, client: InvitationClient, connections: ConnectionsClient) {
