...
import com.waz.content.{ConversationStorageImpl, MembersStorageImpl, OtrClientsStorage, UsersStorageImpl}
...
/**
  ...
  */
class VerificationStateUpdater(selfUserId: UserId, usersStorage: UsersStorageImpl, clientsStorage: OtrClientsStorage, convs: ConversationStorageImpl, membersStorage: MembersStorageImpl) {
