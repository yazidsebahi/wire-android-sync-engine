...
import com.waz.content.{ConversationStorageImpl, MembersStorageImpl, OtrClientsStorage, DefaultUsersStorage}
...
/**
  ...
  */
class VerificationStateUpdater(selfUserId: UserId, usersStorage: DefaultUsersStorage, clientsStorage: OtrClientsStorage, convs: ConversationStorageImpl, membersStorage: MembersStorageImpl) {
