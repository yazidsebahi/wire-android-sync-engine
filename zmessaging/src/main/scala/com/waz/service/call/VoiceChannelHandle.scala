...
class VoiceChannelHandle(val id: ConvId, selfUserId: UserId, storage: VoiceChannelStorage, push: PushService, errors: ErrorsService, lifecycle: ZmsLifecycle, service: VoiceChannelService)(implicit val dispatcher: SerialDispatchQueue) {
