...
import com.waz.content.{DefaultConversationStorage, DefaultUsersStorage, VoiceChannelStorage}
...
class VoiceChannelContent(context: Context, val storage: VoiceChannelStorage, convs: DefaultConversationStorage, users: DefaultUsersStorage, callLog: DefaultCallLogService) { self =>
