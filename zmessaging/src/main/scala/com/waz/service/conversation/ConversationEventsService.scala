...
class ConversationEventsService(convs: DefaultConversationsContentUpdater, messages: DefaultMessagesService, users: DefaultUserService, sync: SyncServiceHandle, pipeline: EventPipeline) {
