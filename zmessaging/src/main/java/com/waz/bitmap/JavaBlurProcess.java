...
/**
 * Borrowed from: https://github.com/kikoso/android-stackblur/tree/master/StackBlur/src/com/enrique/stackblur
 */
public class JavaBlurProcess {
    ...
    public static void blurIteration(int[] src, int w, int h, int radius, int cores, int core, int step) {
        int x, y, xp, yp, i;
        int sp;
        int stack_start;
        int stack_i;
